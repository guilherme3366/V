...
import { X, User, Phone, Mail, FileText, Plus, Loader2, MapPin, Calendar as CalendarIcon } from 'lucide-react';
...
const NewClientModal: React.FC<NewClientModalProps> = ({ isOpen, onClose, onCreated }) => {
  ...
  const handleSubmit = async () => {
    if (!formData.nome.trim() || isCreating) return;
        ...
        <div className="fixed inset-0 z-[201] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                <h3 className="text-2xl font-black tracking-tight text-white">Novo Cliente</h3>
                <p className="text-[10px] text-white/20 uppercase tracking-[0.2em] font-mono mt-1">Cadastrar no sistema</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex gap-4 pt-6 mt-4 border-t border-white/5">
              ...
              <button
                ...
                disabled={!formData.nome.trim() || isCreating}
